...
export default function({children}){
    ...
    <div className="drawer-content">
        ...
        <div className="flex-none">
           {auth.user.image?(
                        <img src={`/storage/${auth.user.image}`} alt="" className="ml-2 rounded-full h-10 w-10 ring-2 ring-white/80 object-cover"/>
           ) : (
                        <div className="ml-2 rounded-full h-10 w-10 bg-white/20 ring-1 ring-white/30 flex items-center justify-center">
                            <span className="text-white font-bold">{auth.user.username.toUpperCase().slice(0, 1)}</span>
            </div>
           )}
        ...
        {/* Page content here */}
        <div className="p-4 bg-[linear-gradient(180deg,_rgba(255,249,241,0.96)_0%,_rgba(255,253,249,1)_100%)]">{children}</div>
    </div>

    <div className="drawer-side is-drawer-close:overflow-visible">
        <label htmlFor="my-drawer-4" aria-label="close sidebar" className="drawer-overlay"></label>
        <div className="flex min-h-full flex-col items-center border-r border-[#e0c87f]/60 bg-gradient-to-b from-[#fffaf3] via-[#f9edd8] to-[#efd8b4] is-drawer-close:w-14 is-drawer-open:w-64 shadow-[8px_0_30px_rgba(122,24,24,0.08)]">
